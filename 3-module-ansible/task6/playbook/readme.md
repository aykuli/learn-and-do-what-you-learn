...
Архитектура
--------------инвентиризации для пследующих сценариев
...
* **aykuli.yandex_cloud_elk.fcreate**: Создаёт из сообщения предыдущего модуля файл 
- на 3 сервера устанавливаются `Vector` - менеджер логов, `ClickHouse` - хранитель логов, и `Lighthouse` - веб-интерфейс для просмотра логов, и настраиваются.
