...
После удаления ресурсов, файлы с папкой с неймспейсом удалены, так как, как показано на скриншоте выше, `Reclaim Policy: Delete`. Это дефолтное значения для `hostpath` addon.
