resource "yandex_iam_service_account" "ig-support" {
  name        = "ig-support"
...
resource "yandex_resourcemanager_folder_iam_member" "ig-storage-editor" {
  ...
  role      = "editor"
  member    = "serviceAccount:${yandex_iam_service_account.ig-support.id}"
}
...
# resource "yandex_storage_bucket" "ayn-bucket-202609" {
...
#   access_key = yandex_iam_service_account_static_access_key.ig-support-static-key.access_key
#   secret_key = yandex_iam_service_account_static_access_key.ig-support-static-key.secret_key
#   bucket     = yandex_storage_bucket.ayn-bucket-202609.id
#   key        = "cat.jpg"
#   source     = "${path.module}/assets/cat.jpg"
#   acl        = "public-read"
# }

# resource "yandex_storage_object" "ayn-index" {
#   access_key = yandex_iam_service_account_static_access_key.ig-support-static-key.access_key
#   secret_key = yandex_iam_service_account_static_access_key.ig-support-static-key.secret_key
#   bucket     = yandex_storage_bucket.ayn-bucket-202609.id
#   key        = "index.html"
